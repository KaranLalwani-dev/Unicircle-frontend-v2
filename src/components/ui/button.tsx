  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 ease-out active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-black/10 dark:border-white/10 bg-transparent backdrop-blur-md shadow-sm hover:shadow-md hover:bg-black/5 dark:hover:bg-white/10 hover:text-accent-foreground",
        secondary: "bg-transparent backdrop-blur-md text-secondary-foreground shadow-sm hover:shadow-md border border-transparent hover:bg-black/5 dark:hover:bg-white/10",
        ghost: "bg-transparent hover:backdrop-blur-md hover:bg-black/5 dark:hover:bg-white/10 hover:text-accent-foreground",
